...
aws iam detach-role-policy --role-name $ROLE_NAME --policy-arn arn:aws:iam::$ACCOUNT_ID:policy/deltaProtect-customPolicy && \
...
aws iam delete-policy --policy-arn arn:aws:iam::$ACCOUNT_ID:policy/deltaProtect-customPolicy && \
