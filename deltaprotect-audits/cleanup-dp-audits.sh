# Detach policies & Delete Delta Protect Audit IAM Role

ROLE_NAME="deltaprotect-audits"
...
aws iam detach-role-policy --role-name $ROLE_NAME --policy-arn arn:aws:iam::$ACCOUNT_ID:policy/deltaProtect-customPolicy.json && \
...
aws iam delete-policy --policy-arn arn:aws:iam::$ACCOUNT_ID:policy/deltaProtect-customPolicy.json && \
